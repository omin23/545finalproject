...
parser.add_argument("--train_path", type=str, default='./mouse_train.h5ad')
parser.add_argument("--valid_path", type=str, default='./mouse_valid.h5ad')
parser.add_argument("--ckpt_dir", type=str, default='./ckpts_mouse/')
parser.add_argument("--model_name", type=str, default='pretrain_with_val')
