...
def evaluate(pred_csv, true_h5ad, tag):
    ...
    # Step 1: Load prediction and ground truth
...
def visualize_umap_full(pred_csv, full_h5ad, tag="MS_all"):
...
if __name__ == "__main__":
    ...
    visualize_umap_full("prediction_MS_all.csv", "data/filtered_ms_data.h5ad", tag="MS_all")
