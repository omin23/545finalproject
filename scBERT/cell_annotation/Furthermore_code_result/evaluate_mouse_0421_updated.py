...
# ========= UMAP Visualization on Full Data ==========
def visualize_umap_full(pred_csv, full_h5ad, tag="mouse_all"):
    print(f"===== Generating UMAP on full dataset: {tag} =====")
    df = pd.read_csv(pred_csv)
    ...
    print(f"UMAP saved to figures_0421/umap_predicted_{tag}_0421.svg\n")


# ========= Main Logic ==========
if __name__ == "__main__":
    # Only evaluate on split sets
    ...
    # Only generate UMAP once on full data
    visualize_umap_full("prediction_mouse_all.csv", "data/mouse_all.h5ad", tag="mouse_all")
