...
parser.add_argument("--n_clusters", type=int, default=18)
parser.add_argument("--output_prefix", type=str, default="prediction_MS")
...
adata_valid.write("data/MS_valid_0421.h5ad")
adata_test.write("data/MS_test_0421.h5ad")
print("Saved data/MS_valid_0421.h5ad and data/MS_test_0421.h5ad")
...
def run_predict(adata_split, name_suffix):
    ...
    cell_types = adata_split.obs["celltype"].values
    cls_vectors = []
